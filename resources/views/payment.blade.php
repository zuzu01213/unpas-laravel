...
<style>
    ...
    .card{ border:none; }
    .form-control { border-bottom: 2px solid #eee !important; border: none; font-weight: 600 }
    .form-control:focus { color: #495057; background-color: #fff; border-color: black; outline: 0; box-shadow: none; border-radius: 0px; ; }
    ...
    .hightlight{ background-color: black; padding: 10px; border-radius: 10px; margin-top: 15px; font-size: 14px; }
    .yellow{ color: brown; }
    .decoration{ text-decoration: none; font-size: 14px; }
    .btn-success { color: #fff; background-color: brown; border-color:black; }
    .btn-success:hover { color: #fff; background-color:black; border-color: black; }
    .decoration:hover{ text-decoration: none; color: brown; }
</style>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="mt-4 mb-4 d-flex justify-content-between">
                        ...
                        <button class="btn btn-dark px-3">Pay $840</button>
                    </div>
        </div>
        <div class="col-md-4">
